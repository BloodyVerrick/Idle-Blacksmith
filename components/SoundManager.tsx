...
const playSound = (context: AudioContext, soundGenerator: (time: number) => void) => {
...
// --- Enhanced Sound Definitions using Web Audio API ---

// A more detailed mining sound with layers for impact, metal, and rock crunch.
const createMineSound = (context: AudioContext) => (time: number) => {
    // 1. Metallic "ping"
...
const createForgeSound = (context: AudioContext) => (time: number) => {
...
const createSellSound = (context: AudioContext) => (time: number) => {
    // Sparkle
...
const createUpgradeSound = (context: AudioContext) => (time: number) => {
    const masterGain = context.createGain();
...
const createBaggingSound = (context: AudioContext) => (time: number) => {
...
const createCanningSound = (context: AudioContext) => (time: number) => {
    const osc = context.createOscillator();
